    ...
    <div class="row">
      ...
      <div class="col mb-2">
        <div class="input-group">
          ...
          <input v-model.lazy.trim="searchObject.givenName" class="form-control" placeholder="$t('givenName')" />
        </div>
      </div>
      <!-- last name -->
      <div class="col mb-2">
        <div class="input-group">
          ...
          <input v-model.lazy.trim="searchObject.lastName" class="form-control" placeholder="$t('lastName')" />
        </div>
      </div>
    </div>
  </div>
